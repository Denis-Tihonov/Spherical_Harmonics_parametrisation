...
\abstract
    {\textbf{Аннотация}:
    Цель данной работы - построить модель аппроксимации наименьшей структурной сложности.
    Для этогов решается задача аппроксимации фазовой траектории, построенной по квазипериодическому временному ряду.
...
\bigskip
\textbf{Ключевые слова}: \emph {временные ряды, траекторное подпространство, фазовая траектория, аппроксимация, сферические гармоники, матрица Ганкеля}.}
